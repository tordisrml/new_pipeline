...
! Days of the year at the beginning of each month.
	  ...
	  open(10,file='../'//yearmonth//filename1) !The main data file
...
!          write(*,*)j
  ...
  31  continue
	  ...
	  open(20,file='../'//yearmonth//'/dmu_data/tdm1.dat')
	  open(22,file='../'//yearmonth//'/dmu_data/tdm2.dat')
	  open(23,file='../'//yearmonth//'/dmu_data/tdm3.dat')
...
!	  goto 999
  ...
  224 format(i15,1x,i8,1x,i2,i3,3(1x,i5),i2)
      ...
      open(21,file='../'//yearmonth//'/dmu_data/dmu_ped.txt')
	  open(24,file='../'//yearmonth//'/dmu_data/radnrkodi')
...
!		if(extra_year(i).gt.sphg(nsphg))pl=pl+1
	  ...
	  close(25)
	  open(31,file='../'//yearmonth//'/dmu_data/damphgout.txt')          !Skrá með fjölda í draugahópum til upplýsinga
      open(32,file='../'//yearmonth//'/dmu_data/sirephgout.txt')
	  do i=1,ndphg
